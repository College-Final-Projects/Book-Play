...
function displayVenueDetails(venue) {
    ...
    document.getElementById("placeName").innerHTML = `<strong>Place Name:</strong> ${venue.place_name || 'N/A'}`;
    document.getElementById("location").innerHTML = `<strong>Location:</strong> ${venue.location || 'N/A'}`;
    document.getElementById("description").innerHTML = `<strong>Description:</strong> ${venue.description || 'N/A'}`;
    document.getElementById("sportCategory").innerHTML = `<strong>Sport Category:</strong> ${venue.SportCategory || 'N/A'}`;
    document.getElementById("ownerUsername").innerHTML = `<strong>Owner Username:</strong> ${venue.owner_username || 'N/A'}`;
    
    // For email, we don't have it directly in the facilities table, but you could fetch it from users table if needed
    document.getElementById("ownerEmail").innerHTML = `<strong>Owner Email:</strong> ${venue.owner_email || 'N/A'}`;
